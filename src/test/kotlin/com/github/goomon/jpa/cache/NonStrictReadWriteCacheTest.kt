...
class NonStrictReadWriteCacheTest : AbstractTest() {
    ...
    @DisplayName("NON_STRICT_READ_WRITE 캐시 기본 동작 테스트")
    @Test
    fun nonStrictReadOnlyCacheTest() {
        // initial state
    ...
    @DisplayName("IDENTITY인 NON_STRICT_READ_WRITE 캐시 기본 동작 테스트")
    @Test
    ...
    @DisplayName("NONSTRICT_READ_WRITE 캐시에서 엔터티를 수정이 가능하다.")
    @Test
